...
public class PuzzleGenerator {
    ...
    public void render(Layout layout, String outputPath) {
        ...
        try {
            ...
            GradientPaint paint = new GradientPaint(0f, 0f, randomColor(), 1200f, 800f, randomColor());
            ...
            for (int row = 0; row < rows; row++) {
                for (int col = 0; col < cols; col++) {
                    ...
                    if (tile.getArea().isPresent()) {
                        ...
                        GeneralPath path = buildPath(coords, layout, row, col);
    ...
    private GeneralPath buildPath(double[][] coords, Layout layout, int row, int col) {
        Tile tile = layout.tiles[row][col];
        double x0 = col * layout.tileSize;
        double y0 = row * layout.tileSize;
